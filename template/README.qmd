...
up a new repository for a PROJECT.
We made {{< meta gh.repo >}} because we manage and
develop several PROJECTS in Seedcase, and this template is designed to
make it easier to create, develop, and maintain those PROJECTS.
