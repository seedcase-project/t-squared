...
find while using t-squared. You can do this by creating a
[new](https://github.com/seedcase-project/t-squared/issues/new/) issue
...
To contribute to `t-squared`, you first need to install
