...
template questions, some of these features may not be included in the created
project:
...
- [`.zenodo.json`](https://help.zenodo.org/docs/github/describe-software/zenodo-json/)
  ...
  metadata to create a DOI for the website, as well as `CITATION.cff`
  file for GitHub to display the citation information on the repository
  page.
